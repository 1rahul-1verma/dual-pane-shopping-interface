...
/**
 * @param {0} isSelected -> defines if an item is selected
 * @param {1} onSelect -> callback, which handles items select/deselect
 * @param {2} item -> items object itself
 * @return -> An Individual items
 */
...
/**
 * @return -> List of Items in the online SHOP
 */
export const ItemsList = () => {
  // Local state to keep selected items
